...
@section('content')
        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="m-b-10">Savollar</h5>
                </div>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                    <li class="breadcrumb-item">Savollar</li>
                </ul>
            </div>
                                        ...
                                        <tr class="single-item">
                                            ...
                                            <td>
                                                <div class="hstack gap-2 justify-content-end">
                                                    <a href="javascript:void(0)" data-bs-toggle="offcanvas" data-bs-target="#tasksDetailsOffcanvasEdit{{ $question->id }}" class="avatar-text avatar-md">
    ...
    @include('components.admin.questions.question-modal-create')
    @include('components.admin.questions.question-modal-edit', ['questions' => $questions])
@endsection
