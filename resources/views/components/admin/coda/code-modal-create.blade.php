    ...
    <div class="offcanvas-header border-bottom" style="padding-top: 20px; padding-bottom: 20px">
        <div class="d-flex align-items-center">
            ...
            <a href="javascript:void(0);">
                ...
                <span class="fs-12 fw-normal text-muted text-truncate-1-line">Kod yaratish</span>
            </a>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        <label class="form-label">Maxsus kod:</label>
                        <input type="text" name="code" class="form-control">
                    </div>
                </div>
                <button type="submit" class="btn btn-primary d-inline-block mt-4">Kod qo'shish</button>
            </div>
        </form>
    </div>
