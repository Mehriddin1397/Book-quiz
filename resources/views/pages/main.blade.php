        ...
        <div class="container py-5 px-lg-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <p class="section-title text-secondary">Viktorina haqida<span></span></p>
                    <h1 class="mb-5">Mamlakatdagi birinchi Viktorina veb ilovasi</h1>
                    <p class="mb-4"></p>
                    <div class="skill mb-4">
                        <div class="d-flex justify-content-between">
                            <p class="mb-2">Viktorinamizga qantashganlar</p>
                            <p class="mb-2">98%</p>
                        </div>
                        <div class="progress">
                    ...
                    <div class="skill mb-4">
                        <div class="d-flex justify-content-between">
                            <p class="mb-2">Bosh sovrinni qo'lga kiritganlar</p>
                            <p class="mb-2">40%</p>
                        </div>
                        <div class="progress">
                    ...
                    <a href="{{route('start')}}" class="btn btn-primary py-sm-3 px-sm-5 rounded-pill mt-3">Viktorinani boshlash</a>
                </div>
                <div class="col-lg-6">
